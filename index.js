...
const port = 3002;
const subdomain = "https://d1vashechkin.amocrm.ru/"  // ДЛя теста заменить домен на тестириуемый
...
const server = http.createServer(async (req, res) => {
   ...
   const get_token = await axios.post (subdomain+'/oauth2/access_token', {
    ...
    for (i=0; i<contacts_without_leads.length; i++){   //Не уверен, что делать POST запросы в цикле наилучшая идея, но другого способа отправить данные пакетно я не нашел
